...
const Header = () => {
  ...
  return (
    <header className="fixed ml-64 top-0 left-0 right-0 bg-gradient-to-r from-gray-700 to-gray-500 text-white p-4 flex justify-between items-center h-16 shadow-md z-10">
      ...
      {isLoggedIn && userDetails && (
        <div className="relative">
          ...
          >
            ...
            <span className="max-w-[150px] truncate">{userDetails.name}</span>
            <FaChevronDown
            ...
            >
              <div className="space-y-2">
                <p className="flex justify-between">
                  ...
                  <span className="text-right">{userDetails.name}</span>
                </p>
                <p className="flex justify-between">
                  <strong className="text-gray-600">Email:</strong>
                  <span className="text-right break-all">{userDetails.email}</span>
                </p>
              </div>
              <button
