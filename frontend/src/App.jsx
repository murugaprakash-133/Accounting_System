    ...
    <Router>
      <div className="flex flex-col h-screen">
        ...
        <div className="flex flex-grow">
          ...
          <div className="flex-grow p-4">
            <Routes>
              ...
              <Route
                path="/income-expense"
                element={isLoggedIn ? <IncomeExpense /> : <Navigate to="/" />}
              />
              <Route
                path="/profit-loss"
                element={isLoggedIn ? <Profit_Loss /> : <Navigate to="/" />}
              />
              {/* <Route path="/cash-flow" element={isLoggedIn ? <CashFlowPart /> : <Navigate to="/" />} /> */}
              <Route
                path="/monthly-reports"
                element={isLoggedIn ? <MonthlyReport /> : <Navigate to="/" />}
              />
              <Route
                path="/detailed-reports"
                element={
                  isLoggedIn ? <DetailedReportslide /> : <Navigate to="/" />
                }
              />
              <Route
                path="/manage-recipients"
                element={
                  isLoggedIn ? <ManageRecipients /> : <Navigate to="/" />
                }
              />
        ...
        <ToastContainer
          ...
          closeOnClick
          rtl={false}
          pauseOnFocusLoss={false} // Prevents pausing when focus is lost
          draggable
